...
const locators = require('./AddChargableTicketwithRawInv.json');
...
async function addticketwithRawInv(page, customer, product_type, technician, item_name, Qty, rate) {
...
module.exports = { navigate_ticket, addticketwithRawInv, reports, SACcustomeraccledger };